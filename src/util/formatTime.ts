...
/**
 * Formats a given millisecond integer to human-readable text 
 ...
 * @param options `longNames` - whether to display amounts as compact or not, e.g. (`s`) or (`seconds`). `commas` - Whether to separate each accuracy with a comma or not
